/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env --env stage` (hash: 0fdadcdf20aac8da6d80d1f1c6df4229)
// Runtime types generated with workerd@1.20250913.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		STRIPE_PRODUCT_BASIC: "price_1SPoOCFQxANz59GflcPoEASJ";
		STRIPE_PRODUCT_PRO: "price_1SPoOCFQxANz59GflcPoEASJ";
		STRIPE_PRODUCT_ENTERPRISE: "price_1SPoOCFQxANz59GflcPoEASJ";
		GITHUB_CLIENT_ID: "Ov23liZjvcTLo2pyeDuD";
		GITHUB_CLIENT_SECRET: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_WEBHOOK_KEY: string;
		APP_SECRET: string;
		DB: D1Database;
		BACKEND_SERVICE: Fetcher /* click-audit-service-stage */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRIPE_PRODUCT_BASIC" | "STRIPE_PRODUCT_PRO" | "STRIPE_PRODUCT_ENTERPRISE" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_KEY" | "APP_SECRET">> {}
}
